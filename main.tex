...
\begin{document}
    ...
    \section{LoraWan Funktionsweise}
        ...
        \subsection{Protokoll} \label{sec:protokoll}
            ...
            Mit der Unterteilung des \marginpar{wirklich richtig?} MACPayload springen wir din dem LoRaStack noch eine ebene höher in die Applickationsschicht. Enthalten im MAcPayload feld sind der Frameheader (FHDR), der Frame Port (FPort) und der Frame payload (FRMPayload).
