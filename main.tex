...
\begin{document}
    ...
    \section{LoraWan Funktionsweise}
        ...
        \subsection{Schichtenmodell}
            ...
            Mehr zu den Klassen kann im Kapitel \nameref{sec:klassen} und im Kapitel \nameref{sec:protokoll} gelesen 
            werden.
        ...
        \subsection{Netzwerkbeitritt}
            ...
            Hierfür müssen folgende 4 Konstanten Vorgegeben werden. DevEUI, JionEUI , NwkKey, AppKey \marginpar{Verschlüsselung des join requests}.
