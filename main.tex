    ...
    \section{LoRaWAN Funktionsweise}
        ...
        \subsection{Netzwerkbeitritt}
            ...
            \subsubsection{OTAA} \label{sec:OTAA}
                ...
                Näheres zu den Konstanten kann im Kapitel \nameref{sec:endgerät} nachgelesen werden.
        ...
        \subsection{Protokoll} \label{sec:protokoll}
            ...
            \subsubsection{MAC-Kommandos}
                ...
                \begin{tabular}{c |c | p{10.5cm} c}
                    ...
                    0x02 & LinkCheckReq & Wird vom Endgerät verwendet die verbindung zum Netzwerk zu überprüfen. \\
                    ...
                    0x04 & DutyCycleReq & Das Gateway Teilt dem Endgerät mit wie oft die Verbindung getestet weredn soll \\
